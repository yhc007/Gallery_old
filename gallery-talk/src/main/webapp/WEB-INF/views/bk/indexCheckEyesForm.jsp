		...
		<form name="checkForm" id="checkForm" method="post" action="">
			...
			<table class="staffList" width="800" border="0.5">
				...
				<tr>
					...
					<td><input type="text" size="3"   style="font-size: 17px" onclick ="resetInput(pdRight);"
						id="pdRight" name="pdRight" ></input></td>
					<td><input type="text" size="3"   id="addRight" name="addRight" style="font-size: 17px"
						onchange="formatNoSign(addRight)" onclick ="resetInput(addRight);"></input></td>
					
					<td height="66"><input type="text" size="3" style="font-size: 17px"  class="notUse"
				...
				<tr>
					...
					<td><input onclick ="resetInput(gsphLeft);" type="text" size="3" style="font-size: 17px"  id="gsphLeft"
						name="gsphLeft" onchange="format(gsphLeft)" ></input></td>
					<td><input onclick ="resetInput(gcylLeft);" type="text" size="3" style="font-size: 17px"  id="gcylLeft"
						name="gcylLeft" onchange="format(gcylLeft)"></input></td>
					<td><input onclick ="resetInput(gaxisLeft);" type="text" size="3" style="font-size: 17px"  id="gaxisLeft"
						name="gaxisLeft"></input></td>
					<td><input onclick ="resetInput(pdLeft);" type="text" size="3" style="font-size: 17px"  id="pdLeft"
						name="pdLeft" ></input></td>
					<td><input onclick ="resetInput(addLeft);" type="text" size="3" style="font-size: 17px"  id="addLeft"
						name="addLeft" onchange="formatNoSign(addLeft)"></input></td>
						
					<td height="66"><input onclick ="resetInput(npcLeft);" type="text" size="3" style="font-size: 17px"  class="notUse"
						id="npcLeft" name="npcLeft" onchange="formatNoSign(npcLeft)"></input></td>
					<td height="66"><input onclick ="resetInput(npaLeft);" type="text" size="3" style="font-size: 17px"  class="notUse"
						id="npaLeft" name="npaLeft" onchange="format(npaLeft)"></input></td>
					<td height="66"><input onclick ="resetInput(prismLeft);" type="text" size="3" style="font-size: 17px"  class="notUse"
						id="prismLeft" name="prismLeft" onchange="formatNoSign(prismLeft)"></input></td>
					<td height="66"><input onclick ="resetInput(baseLeft);" type="text" size="3" style="font-size: 17px"  class="notUse"
				...
				<tr>
					<td height="66">Right</td>
					<td><input onclick ="resetInput(lsphRight);" type="text" size="3" style="font-size: 17px"  id="lsphRight"
						name="lsphRight" onchange="format(lsphRight)"></td>
					<td><input onclick ="resetInput(lcylRight);" type="text" size="3" style="font-size: 17px"  id="lcylRight"
						name="lcylRight" onchange="format(lcylRight)"></td>
					<td><input onclick ="resetInput(laxisRight);" type="text" size="3" style="font-size: 17px" 
						id="laxisRight" name="laxisRight"></td>
					<td><input onclick ="resetInput(bcRight);" type="text" size="3" style="font-size: 17px"  id="bcRight"
						name="bcRight"onchange="formatNoSign(bcRight)"></td>
					<td><input onclick ="resetInput(diaRight);" type="text" size="3" style="font-size: 17px"  id="diaRight"
						name="diaRight" onchange="formatNoSign(diaRight)"></td>
						
					<td height="66" colspan="3">
					 좌 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 우 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 없음 </br>
						<input class="dom_eye" type="radio"  value='1' name="domEye" id="domR">
						&nbsp;&nbsp;
						<input class="dom_eye" type="radio"  value='2' name="domEye" id="domL">
						&nbsp;&nbsp;
						<input class="dom_eye" type="radio"  value='0' name="domEye" id="domN">
					</td>
				...
				<tr>
					<td height="66">Left</td>
					<td><input onclick ="resetInput(lsphLeft);" type="text" size="3" style="font-size: 17px"  id="lsphLeft"
						name="lsphLeft" onchange="format(lsphLeft)"></td>
					<td><input onclick ="resetInput(lcylLeft);" type="text" size="3" style="font-size: 17px"  id="lcylLeft"
						name="lcylLeft" onchange="format(lcylLeft)"></td>
					<td><input onclick ="resetInput(laxisLeft);" type="text" size="3" style="font-size: 17px"  id="laxisLeft"
						name="laxisLeft"></td>
					<td><input onclick ="resetInput(bcLeft);" type="text" size="3" style="font-size: 17px"  id="bcLeft"
						name="bcLeft" onchange="formatNoSign(bcLeft)"></td>
					<td><input onclick ="resetInput(diaLeft);" type="text" size="3"style="font-size: 17px"   id="diaLeft"
						name="diaLeft" onchange="formatNoSign(diaLeft)"></td>
					<td width="50" colspan="2">
							<a href="#" onclick="fncSaveCheck();return false;">
