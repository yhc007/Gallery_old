...
<table id="staffTableH" border='1'>
	<tr align='center'>
		...
		<td width='10%' class='alt' rowspan='2'>메모</td>
		<td width='40%'rowspan='2'>
			<textarea rows="3" cols="60" id="memo_txtH" placeholder="메모 작성 후 우측 저장버튼을 누르시면 저장됩니다."></textarea>
		</td>
		<td width='10%'rowspan='2'>
			<input type="button" onclick='saleMemoUpdateH();' value="저장">
		</td>
	</tr>
	<tr align='center'>
		<td class='alt' >직원</td>
		<td><span id="staffNameH"></span><span id="staffIdH"  hidden ></span><span id="saleIdH"  hidden ></span></td>
	</tr>
</table>
