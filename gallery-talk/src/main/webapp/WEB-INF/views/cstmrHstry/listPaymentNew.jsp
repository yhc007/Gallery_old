...
<body>
	<!-- <button id="memo" onclick="showMemo(); return false;">메모</button> -->
	<br>
    ...
    <%-- <div class="btnSave" >
	<img onclick="fncPaymentSave(JUST_SAVE);" src="<c:url value="/images/content/save.png" />"
    ...
    <%-- <img onclick="goBackward();"src="<c:url value="/images/content/back.png" />" width="72" height="72" ></img> --%>
