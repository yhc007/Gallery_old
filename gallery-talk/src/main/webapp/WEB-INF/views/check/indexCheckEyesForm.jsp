	...
	function getCheckInfo(histId) {
		...
		$.ajax({
			...
			success : function(data) {
				...
				console.log("좌,우 위안 : " + data.domEye);
		...
		<form name="checkForm" id="checkForm" method="post" action="">
			...
			<table class="staffList" width="800" border="0.5">
				...
				<tr>
					...
					<td height="66"><input type="text" size="3" tabindex=11 style="font-size: 17px"   class="notUse"
						id="prismRight" name="prismRight" onchange="formatNoSign(prismRight)" onclick ="resetInput(prismRight);"></input></td>
					<td height="66"><input type="text" size="3" tabindex=12 style="font-size: 17px"   class="notUse"
						id="baseRight" name="baseRight" onchange="formatNoSign(baseRight)" onclick ="resetInput(baseRight);"></input></td>	
					<td height="66"><input type="text" size="3" tabindex=13 style="font-size: 17px"  class="notUse"
						id="npcRight" name="npcRight" onchange="formatNoSign(npcRight)" onclick ="resetInput(npcRight);"></input></td>
					<td height="66"><input type="text" size="3" tabindex=14 style="font-size: 17px"  class="notUse"
				...
				<tr>
					...
					<td><input onclick ="resetInput(gsphLeft);" tabindex=6
						type="text" size="3" style="font-size: 17px"  id="gsphLeft"
						name="gsphLeft" onchange="format(gsphLeft)" ></input></td>
					<td><input onclick ="resetInput(gcylLeft);" tabindex=7 type="text" size="3" style="font-size: 17px"  id="gcylLeft"
						name="gcylLeft" onchange="format(gcylLeft)"></input></td>
					<td><input onclick ="resetInput(gaxisLeft);" tabindex=8 type="text" size="3" style="font-size: 17px"  id="gaxisLeft"
						name="gaxisLeft"></input></td>
					<td><input onclick ="resetInput(pdLeft);" tabindex=9 type="text" size="3" style="font-size: 17px"  id="pdLeft"
						name="pdLeft" ></input></td>
					<td><input onclick ="resetInput(addLeft);" tabindex=10 type="text" size="3" style="font-size: 17px"  id="addLeft"
						name="addLeft" onchange="formatNoSign(addLeft)"></input></td>
					
					<td height="66"><input onclick ="resetInput(prismLeft);" tabindex=15 type="text" size="3" style="font-size: 17px"  class="notUse"
						id="prismLeft" name="prismLeft" onchange="formatNoSign(prismLeft)"></input></td>
					<td height="66"><input onclick ="resetInput(baseLeft);" tabindex=16 type="text" size="3" style="font-size: 17px"  class="notUse"
						id="baseLeft" name="baseLeft" onchange="formatNoSign(baseLeft)"></input></td>	
					<td height="66"><input onclick ="resetInput(npcLeft);" tabindex=17 type="text" size="3" style="font-size: 17px"  class="notUse"
						id="npcLeft" name="npcLeft" onchange="formatNoSign(npcLeft)"></input></td>
					<td height="66"><input onclick ="resetInput(npaLeft);" tabindex=18 type="text" size="3" style="font-size: 17px"  class="notUse"
				...
				<tr>
					<td height="66">Right</td>
					<td><input onclick ="resetInput(lsphRight);" tabindex=22 type="text" size="3" style="font-size: 17px"  id="lsphRight"
						name="lsphRight" onchange="format(lsphRight)"></td>
					<td><input onclick ="resetInput(lcylRight);" tabindex=23 type="text" size="3" style="font-size: 17px"  id="lcylRight"
						name="lcylRight" onchange="format(lcylRight)"></td>
					<td><input onclick ="resetInput(laxisRight);" tabindex=24 type="text" size="3" style="font-size: 17px" 
						id="laxisRight" name="laxisRight"></td>
					<td><input onclick ="resetInput(bcRight);" tabindex=25 type="text" size="3" style="font-size: 17px"  id="bcRight"
						name="bcRight"onchange="formatNoSign(bcRight)"></td>
					<td><input onclick ="resetInput(diaRight);" tabindex=26 type="text" size="3" style="font-size: 17px"  id="diaRight"
				...
				<tr>
					<td height="66">Left</td>
					<td><input onclick ="resetInput(lsphLeft);" type="text" tabindex=27 size="3" style="font-size: 17px"  id="lsphLeft"
						name="lsphLeft" onchange="format(lsphLeft)"></td>
					<td><input onclick ="resetInput(lcylLeft);" type="text" tabindex=28 size="3" style="font-size: 17px"  id="lcylLeft"
						name="lcylLeft" onchange="format(lcylLeft)"></td>
					<td><input onclick ="resetInput(laxisLeft);" type="text" tabindex=29 size="3" style="font-size: 17px"  id="laxisLeft"
						name="laxisLeft"></td>
					<td><input onclick ="resetInput(bcLeft);" type="text" size="3" tabindex=30 style="font-size: 17px"  id="bcLeft"
						name="bcLeft" onchange="formatNoSign(bcLeft)"></td>
					<td><input onclick ="resetInput(diaLeft);" type="text" size="3" tabindex=31 style="font-size: 17px"   id="diaLeft"
