...
<script>
	...
	function goCstmrListPage() {
		...
		form.action = '${ctxPath}/cstmr/cstmrListFmlyCd.do';
...
<body class="Screen_Enter">
	<center>
		...
		<form name="cstmrSearchForm" id="cstmrSearchForm" method="post"
			...
			<div class="transBoxTable" style="width: 800; height: 480;">
				<table class="listShop" width="100%" border="0.5">
				<tr>
					<td class="btnTop" width="100" height="26"
				...
				<tr>
					<td height="44" colspan="6">
						<div class="head_title">고객 포인트 카드 검색</div>
					</td>
				</tr>
					<tr>
						<td>&nbsp;</td>
					...
					<!-- <tr>
						...
						<td><form id="form1" name="form1" method="post" action="">
								<span id="sprytextarea1"> <label for="CustomerName"></label>
									<span class="header"></span></span>
							</form></td>
						<td><div align="center" class="nameinput">
								<input type="text" class="nameinput" id="cstmrName"name="cstmrName"  placeholder="이름"/>
							</div><br>
							
							<div align="center" class="nameinput">
								<input type="text" class="nameinput" id="cstmrPhone"name="cstmrPhone" placeholder="전화번호 (4자리)"/>
							</div>
					...
					<tr height="63">
						<td>&nbsp;</td>
						<td>
							<select id='slctSearch1' class="searchSlct" name='searchTy1' ></select>
						</td>
						<td>
						...
						<td>
							<select id='slctSearch2' class="searchSlct" name='searchTy2' ></select>
						</td>
						<td>
							<input type="text" class="nameinput" id="txtSearch2" name="searchText2"  placeholder="조건2"
							onKeyPress="javascript:if(event.keyCode == 13) goCstmrListPage();"/>
						</td>
						<td>&nbsp;</td>						
					</tr>
...
<%-- 					    <td colspan="2">
 ...
 --%>						<td colspan="6">
					...
					<script>
						...
						document.getElementById("slctSearch2").value=3;
