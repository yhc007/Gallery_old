...
public class CommonCode {
	...
	static{
		...
		codeMap.put(CODE_SHOP_OPR_ING			,MSG_SHOP_OPR_ING);
		codeMap.put(CODE_SHOP_OPR_STOP			,MSG_SHOP_OPR_STOP);
	...
	/*
	public static final String ATTR_CSTMR_ID="cstmrId";
	public static final String ATTR_CSTMR_NAME="cstmrName";
	*/
