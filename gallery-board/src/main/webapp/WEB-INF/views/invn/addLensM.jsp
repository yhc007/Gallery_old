...
<script type="text/javascript">
	...
	function getfunctionList(){
		var brandId = $("#brandId").val();
		var mtrl = $("#mtrl").val();
		var param = "mtrl=" + mtrl + "&brandId=" + brandId + "&shopTy=shop";
	...
	function addNewPrdct(){
		...
		var url = "${ctxPath}/invn/addShopLens.do";
		$.ajax({
			url : url,
			type : "post",
			data : param,
	...
	function getPrdctList(){
		...
		var mtrl = $("#mtrl").val();
		var tyId = $("#tyId").val();
		var param = "brandId=" +brandId + "&mtrl=" + mtrl + "&tyId=" +tyId + "&shopTy=shop";
	...
	function getPrdctRate(){
		...
		var param = "brandId=" +brandId + "&mtrl=" + mtrl + "&tyId=" +tyId + "&prdctName=" + prdctName + "&allPrdct=" + allPrdct + "&shopTy=shop";
