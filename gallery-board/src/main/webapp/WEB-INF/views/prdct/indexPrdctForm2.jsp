	...
	<div id="content">
			...
			<form name="listPrdctForm2"  id="listPrdctForm2" method="post" action="">
					...
					<table width="100%" border="1" class="detail"> 
						...
						<tr>
							<th><label for="">입고 가*</label></th>
							<td>
								<input type="text" id='puchasPrc' name='puchasPrc' title='구매가' onkeydown="if (event.keyCode == 13){return false;}">
							</td>
							<th><label for="">판매 가*</label></th>
							<td>
