...
<thead>
	<tr>
		<th>NO.</th>
		<!-- <th>날짜</th> -->
		<th onclick="getTradeDataS('shopName')">매장</th> 
		<th onclick="getTradeDataS('comName')">협력사</th>
		<th onclick="getTradeDataS('cnt')">수량</th>
		<!-- <th>수량</th> -->
		<th>공급가</th>
		<th>부가세</th>
		<th>합계</th>
	...
	<c:choose>
		...
		<c:set var="flag" value="a">
			...
			<c:otherwise>
				...
				<tr class='${cssClass}'  onclick="getDetailS('${trde.test1}','${trde.shopId }')">
					...
					<c:set var="tax" value="${trde.total * trde.tax/100}"></c:set>
