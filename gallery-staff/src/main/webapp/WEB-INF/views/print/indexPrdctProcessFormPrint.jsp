	...
	function getBillInfo(saleId){
		...
		$.ajax({
			...
			success : function(data){
				...
				$(".etcDscnt").html(format(data.etcDscnt));
				
				$(".remain").html(format(sum_-data.prc-data.etcDscnt));
				funcCnt++;
				print_();
			}
		});
...
<style>
	...
	#cstmrInfoTbl1 td, #cstmrInfoTbl2 td, #cstmrInfoTbl td, #chkEyesTbl td, .paymentTbl td, .billTbl td{
		font-size: 13px;
		/* font-size: 51%; */
	}
	.dotLine{
			...
			<td width='50%'>
				<table id="cstmrInfoTbl1" width='100%' border="1" style="border-collapse: collapse; text-align: center">
					<tr style="height: 20px;">
						...
						<td colspan="2">포인트</td>
						<td class="cstmrPoint" colspan="3"></td>
					</tr >
					<tr style="height: 20px;">
						<td colspan="2">지점</td>
						<td colspan="3">${shopVo.shopName}</td>
						<td colspan="2">전화번호</td>
						<td colspan="3">${cstmrVo.telephone }</td>
					...
					<tr style="height: 20px;">
						...
						<td colspan="2">휴대폰</td>
						<td colspan="3">${cstmrVo.cellphone }</td>
					</tr>
					<tr style="height: 20px;">
						<td colspan="5" style="text-align: center">주소</td>
						<td colspan="5" style="text-align: center">${cstmr.addr}</td>
					</tr>
					<tr style="height: 20px;">
						<td colspan="5" style="text-align: center">고객코드</td>
						<td colspan="5" style="text-align: center">${cstmr.cstmrCd}</td>
					</tr>
					<tr style="height: 20px;">
						<td colspan="5" style="text-align: center">이메일</td>
						<td colspan="5" style="text-align: center">${cstmr.email}</td>
					</tr>
					<tr >
						<td colspan="5" style="text-align: center">총 방문 횟수 : <span class="visitCnt"> 회</span></td>
						<td colspan="5" style="text-align: center">구매금액 : <span class="totalPrc"></span>원</td>
					</tr>
					...
					<tr>
						<td>Right</td><td class="gsphRight"></td><td class="gcylRight"></td><td class="gaxisRight"></td><td class="pdRight"></td><td class="addRight"></td><td class="prismRight"></td><td class="baseRight"></td><td class="npcRight"></td><td class="npaRight"></td>
					</tr>
					<tr>
						<td>Left</td><td class="gsphLeft"></td><td class="gcylLeft"></td><td class="gaxisLeft"></td><td class="pdLeft"></td><td class="addLeft"></td><td class="prismLeft"></td><td class="baseLeft"></td><td class="npcLeft"></td><td class="npaLeft"></td>
					</tr>
					<tr>
						<td>C/L</td><td>SPH</td><td>CYL</td><td>AXIS</td><td >B.C</td><td>DIA</td><td colspan="4" rowspan="3" valign="mclassdle">우위안 <span class="dom"></span></td>
					</tr>
					<tr>
						<td>Right</td><td class="lsphRight"></td><td class="lcylRight"></td><td class="laxisRight"></td><td class="bcRight"></td><td class="diaRight"></td>
					</tr>
					<tr>
						<td>Left</td><td class="lsphLeft"></td><td class="lcylLeft"></td><td class="laxisLeft"></td><td class="bcLeft"></td><td class="diaLeft"></td>
					</tr>
			...
			<td width='50%'>
				<table id="cstmrInfoTbl2" width='100%' border="1" style="border-collapse: collapse; text-align: center">
					<tr>
						...
						<td colspan="8">안경사 : ${staffVo.staffName }</td>
					</tr>
					<tr>
						<td colspan="1" >이름</td>
						<td colspan="3" >${cstmr.cstmrName}</td>
		...
		<tr id='tr_5'>
			...
			<table id='paymentTbl3' class="paymentTbl" width="100%" border="1" style="border-collapse: collapse; text-align: center">
					...
					<c:choose>
						...
						<tr>
								<td>기타할인</td>
								<td class="etcDscnt" style="text-align: right; padding-right: 5px">&nbsp;</td>
								<td>카드</td>
