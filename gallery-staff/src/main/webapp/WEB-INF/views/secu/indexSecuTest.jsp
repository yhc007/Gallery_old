	...
	function goAuth(sn, mac, ip){
		...
		$.ajax({
			...
			success : function(data){
				if(data.trim()!="success"){
					//alert("인증되지 않은 PC입니다.");
					document.getElementById("rst").innerHTML="인증 실패. 인증되지 않은 PC입니다";

					//window.location.href="http://www.daum.net/";
				}else{
					//alert("인증된 PC 입니다.");
					document.getElementById("rst").innerHTML="인증 성공. 인증된 PC입니다";
				}
			}
		});
	}
...
<center>
	...
	<H2 style='color:white;'>[매장명, 인증여부] 를 010-8576-5646 으로 문자 전송 바랍니다.</H2>
	<H2 style='color:white;'>예시) 본점 pc 2대 인증 되었습니다.</H2>
