...
<script>
	...
	function addCnt(obj){
	   ...
	   var y = td.offsetTop;
		...
		if($(obj).width()=="25"){
	   	...
	   	console.log(spec + "/" + y);
	   	if(z==1){
	   		//spec = $(".border")[v].childNodes[0].nodeValue + $(".n2")[v].childNodes[0].nodeValue;
	   		spec = $(".specTd_")[v].childNodes[0].childNodes[0].nodeValue + $(".specTd_")[v].childNodes[1].childNodes[0].nodeValue;
	   	}else if(z==2){
	   		spec = $(".specTd_")[v+20].childNodes[0].childNodes[0].nodeValue + $(".specTd_")[v+20].childNodes[1].childNodes[0].nodeValue;
	   	}else if(z==3){
	   		spec = $(".specTd_")[v+40].childNodes[0].childNodes[0].nodeValue + $(".specTd_")[v+40].childNodes[1].childNodes[0].nodeValue;
	   	}else if(z==4){
	   		spec = $(".specTd_")[v+60].childNodes[0].childNodes[0].nodeValue + $(".specTd_")[v+60].childNodes[1].childNodes[0].nodeValue;
	   	}else if(z==5){
	   		spec = $(".specTd_")[v+80].childNodes[0].childNodes[0].nodeValue + $(".specTd_")[v+80].childNodes[1].childNodes[0].nodeValue;
	   	}	   
	   	
	   	console.log("도수 : " + spec)
	   //	console.log("size : " + $(obj).width())
	...
	function border(n){
		...
		var b = n.substr(0,comma);
		var n2;
		if(n.substr(comma)==".00"){
			n2 = "<span class='border'>" + n.substr(comma) + "</span>"
		}else{
			n2 = "<span class='n2'>" + n.substr(comma) + "</span>"
		}
		n = "<span class='border'> " + b + "</span>" + n2;
		return n;
	}
	function draw(){
		var output = "";
		...
		for(var i = 0; i < 10; i++){
			...
			for(var j = 0; j < 20; j++){
				if(!textInput){
					if(count<=160){
						output += "<td class='specTd_'>" + border(Number(n).toFixed(2)) +"</td>";	
					}else{
		...
		$(".clensSpec").click(function(){
			$(this).html("<input type='text' size=3 onBlur='addCnt(this)' class='specTd'>");
...
<center>
	<form id="PrdctInfo1">
		...
		<table  width="80%" border="1" style="border-collapse: collapse; text-align: center">
			...
			<tr>
				<td><span style="display: none;"><input type="input" id="BC" size="3" class="BC" placeholder="B.C." style="width: 50px">&nbsp;<input type="input" id="diam" size="3" class="diam" placeholder="diam." style="width: 50px"><select id="spec">도수 : <option value="-1"></option selected="selected" ></select></span><select id="devide" data-inline="true">
	...
	<form id="PrdctInfo3">
		...
		<table  border="1" style="border-collapse: collapse; text-align: center">
			...
			<tr>
				...
				<select id="devide" data-inline="true">
																																																																								<option value="-1">할부 </option>
																																																																								<!-- <option value="1">이월</option> -->
																																																																								<option value="2">2개월</option>
																																																																								<option value="3">3개월</option>
			...
			<tr>
				<td colspan="4">
					<table border="1" style="text-align: center; border-collapse: collapse;" id="lensSpecTR">
...
<center>
	<form id="PrdctInfo4">
		...
		<table  width="80%" border="1" style="border-collapse: collapse; text-align: center">
			...
			<tr>
				<td><span style="display: none"><input type="input" id="BC" size="3" class="BC" placeholder="B.C." style="width: 50px">&nbsp;<input type="input" id="diam" size="3" class="diam" placeholder="diam." style="width: 50px"><select id="spec" class="hidden" >도수 : <option value="-1"></option selected="selected"></select></span><select id="devide" data-inline="true">
																																																																																																						<option value="-1">할부 </option>
																																																																																																						<!-- <option value="1">이월</option> -->
																																																																																																						<option value="2">2개월</option>
																																																																																																						<option value="3">3개월</option>
