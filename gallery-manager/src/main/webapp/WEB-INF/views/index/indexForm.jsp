...
<script type="text/javascript">
	...
	var jobChart;
	$(function() {
		$("#prdctRankForm input[id='sdate']").val(today);
 	  	$("#prdctRankForm input[id='edate']").val(today);
		...
		RankChart = new google.visualization.ComboChart(document.getElementById('prdctRankS'));
	  	getPrdctRank();
	  	getProfit();
	  	getStaffChart();
	  	getStaffJob();
	  	...
	  	//change view
	 	   ...
	 	   if(shopId!=777){
	 		   ...
	 		   $("#prdctRankS").css("display","none");
	 		  $(".rankDate").css("display","none");
	 	   }
   ...
   var sdate = removeHypen(today);
  	var edate = removeHypen(today);
	...
	function findShopName() {
		...
		$.ajax({
			...
			success : function(data) {
				var option = "<option value='-1'>목록</option>";
	...
	/* function getSales(shopId) {
		...
		var ystDay = getYesterday();
		var tDay = getToday();
		var param = "yesterDay=" + ystDay + 
						"&toDay=" + tDay + 
						"&shopId=" + shopId;
		$.ajax({
	...
	function getPrdctRank(){
		var sdate = removeHypen($("#prdctRankForm input[id='sdate']").val());
		var edate = removeHypen($("#prdctRankForm input[id='edate']").val());
		var date = new Date();
		var year = date.getFullYear();
	...
	<button onclick="right();" id="rightBtn">></button> -->
		<div id="slider">	
			<div id="chart1" class="chart">
				<table widt="100%">
					<tr>
						...
						<!-- <span style="font-weight: bolder;" onclick="goGalleryBoard()"><a href="#" >갤러리 커뮤니티</a></span> -->
							<!-- <div id="gaugeChart">
								<center>
						...
						<td align="center" width="80%">
							<div id="shopdiv">
							 ...
							 <form id="prdctRankForm">
							 	<input type="date" id="sdate" onchange="getPrdctRank()" class="rankDate">-<input type="date" class="rankDate" id="edate" onchange="getPrdctRank();">
							 	<div id="prdctRankS" ></div> 
			...
			<div id="chart2" class="chart">
				<center><button onclick="swtich('1');">프레임</button><button onclick="swtich('2');">렌즈</button><button onclick="swtich('3');">콘텍트렌즈</button></center>
					<div class="btnDiv">
